...
import { ProductFilterComponent } from './admin/products/components/product-list/search-inline/product-filter/product-filter.component';
import { ProductResultComponent } from './admin/products/components/product-list/search-inline/product-result/product-result.component';
